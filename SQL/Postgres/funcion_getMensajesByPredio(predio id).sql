/*
	getMensajesByPredio(_predio_id)
	Obtiene todos los mensajes realizados por un un predio
*/
CREATE OR REPLACE FUNCTION public.getMensajesByPredio(_predio_id INTEGER)
RETURNS TABLE(
		"id" 			INTEGER,
		"turno_id" 		INTEGER,
		"contenido" 	TEXT,
